...
//   <i> When all Memory is Non-Secure (ALLNS is 1), IDAU can override memory map
//       configuration.
*/
...
*/
#define SAU_INIT_START0    &Image$$ER_CMSE_VENEER$$Base  /* Start address of SAU region 0 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END0      &Image$$ER_CMSE_VENEER$$Limit - 1 /* End address of SAU region 0 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1                __ROM_BASE_NS

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1                  __ROM_BASE_NS + __ROM_SIZE_NS -1
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2                __RAM_BASE_NS

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END2                  __RAM_BASE_NS + __RAM_SIZE_NS -1
...
#define SAU_INIT_REGION(n) \
    ...
    SAU->RBAR =  ((uint32_t)(SAU_INIT_START##n)         & SAU_RBAR_BADDR_Msk); \
    SAU->RLAR =  ((uint32_t)(SAU_INIT_END##n)           & SAU_RLAR_LADDR_Msk) | \
