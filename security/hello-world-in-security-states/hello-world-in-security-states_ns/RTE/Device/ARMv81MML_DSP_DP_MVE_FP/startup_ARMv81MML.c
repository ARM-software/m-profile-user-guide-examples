...
/*CPPWR: SUS10 Enable: the SU10 field is accessible from the Non-secure state.*/
#define SCnSCB_CPPWR_SUS10_Msk         (1UL << SCnSCB_CPPWR_SUS10_Pos)

/*CPPWR: SUS11 Position */
#define SCnSCB_CPPWR_SUS11_Pos         23U

/*CPPWR: SUS11 Enable: the SU11 field is accessible from the Non-secure state.*/
...
__NO_RETURN void Reset_Handler(void)
{
  ...
  /* SU10 & SU11 fields(FPU power control) are accessible from the Non-secure state*/
  SCnSCB->CPPWR = SCnSCB_CPPWR_SUS10_Msk | SCnSCB_CPPWR_SUS11_Msk;
