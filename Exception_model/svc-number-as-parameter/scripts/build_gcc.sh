...
$COMPILER/arm-none-eabi-gcc -march=armv8-m.main -mlittle-endian -O1 -c SelectSVCNumber.c -o logs/SelectSVCNumber.o -DARMv8MML $INCLUDES -g -MMD -MP -MF logs/SelectSVCNumber.d
...
echo "Linking  image..."
$COMPILER/arm-none-eabi-gcc --entry=Reset_Handler -T scripts/gcc_arm.ld -Wl,--gc-sections -march=armv8-m.main --specs=rdimon.specs logs/startup.o logs/system.o logs/main.o logs/SelectSVCNumber.o -o logs/svc-number-as-parameter.axf 
